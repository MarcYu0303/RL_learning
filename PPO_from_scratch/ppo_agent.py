...
# Referring to Proximal Policy Optimization Algorithms
...
class Agent:
    ...
    def remember(self, state, action, reward, probs, vals, done):
            ...
            for t in range(len(reward_arr) - 1):
                ...
                for k in range(t, len(reward_arr) - 1):
                    a_t += discount * (reward_arr[k] +
                                       self.gamma * (1 - int(done_arr[k])) * values[k + 1] -
                                       values[k])  # equation 11, 12
